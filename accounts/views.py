...
from accounts.utils import signin_redirect, get_profile_model, get_user_model
...
from practic.models import PracticalLessonResult, PracticalLesson, CodeQuestion, CodeAnswer, MatrixPracticalLesson,\
